...
import com.adiacent.menarini.guidotti.lab.core.models.RecaptchaValidationResponse;
...
public class MailServlet extends SlingAllMethodsServlet implements OptingServlet {
    ...
    protected String getSecretKey(SlingHttpServletRequest request) {
        try {
            ...
            queryInsidePage.append(" AND s.[sling:resourceType] = 'laboratorio-guidotti/components/form/recaptcha' ");
