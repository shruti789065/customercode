...
public class EventEnrollmentRecord extends UpdatableRecordImpl<EventEnrollmentRecord> implements Record10<Long, Long, Long, String, LocalDateTime, String, LocalDateTime, JSON, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row10<Long, Long, Long, String, LocalDateTime, String, LocalDateTime, JSON, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public EventEnrollmentRecord values(Long value1, Long value2, Long value3, String value4, LocalDateTime value5, String value6, LocalDateTime value7, JSON value8, LocalDateTime value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventEnrollmentRecord(Long id, Long eventId, Long registeredUserId, String isLiveStream, LocalDateTime liveStreamRegistrationTs, String isResidential, LocalDateTime residentialRegistrationTs, JSON inPersonParticipationDateList, LocalDateTime createdOn, LocalDateTime lastUpdatedOn) {
        super(EventEnrollment.EVENT_ENROLLMENT);
