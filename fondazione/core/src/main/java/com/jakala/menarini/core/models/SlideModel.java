...
import com.jakala.menarini.core.models.utils.Constants;
...
@Model(adaptables = { Resource.class, SlingHttpServletRequest.class }, adapters = SlideModelI.class, // Adapts to the CC
																										// model
																										// interface
...
public class SlideModel extends GenericBaseModel implements SlideModelI {
	...
	public static final String RESOURCE_TYPE = "fondazione/components/slideshow/slide-video";
	...
	@Delegate(excludes = DelegationExclusion.class) // Delegate all our methods to the CC Image except those defined
													// below
	...
	private interface DelegationExclusion { // Here we define the methods we want to override
		// String getTitle(); // Override the method which determines the source of the
		// asset
