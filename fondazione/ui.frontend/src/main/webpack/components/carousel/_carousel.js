...
// Added .container class to teaser component in slider
const teaserContents = document.querySelectorAll(
  ".slideshow .teaser .cmp-teaser__content"
);
...
teaserContents.forEach((teaserContent) => {
  ...
  teaserContent.parentNode.insertBefore(containerDiv, teaserContent);
  containerDiv.appendChild(teaserContent);
});
