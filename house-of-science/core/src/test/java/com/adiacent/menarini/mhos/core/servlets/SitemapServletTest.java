...
public class SitemapServletTest {
    ...
    public void setUp() throws IOException, ServletException {
        ...
        ctx.load().json("/com/adiacent/menarini/mhos/core/models/SitemapData.json", "/content/mhos/it/it/who-we-are");

        Resource currentResource = ctx.resourceResolver().getResource("/content/mhos/it/it/who-we-are/jcr:content");
    ...
    public void testSitemapXml() throws ServletException, IOException {
        ...
        Resource dataRes = ctx.resourceResolver().getResource("/content/mhos/it/it/who-we-are");
