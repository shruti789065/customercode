...
public class SitemapServletTest {
    ...
    public void setUp() throws IOException, ServletException {
        ...
        ctx.load().json("/com/adiacent/menarini/relife/core/models/sitemap.json", "/content/relife/corporate/en");

        Resource currentResource = ctx.resourceResolver().getResource("/content/relife/corporate/en/jcr:content");
    ...
    public void testSitemapXml() throws ServletException, IOException {
        ...
        Resource dataRes = ctx.resourceResolver().getResource("/content/relife/corporate/en");
