...
class MailServletTest {
    ...
    void doPost(AemContext context) throws ServletException, IOException, RepositoryException {
        InputStream is = MailServletTest.class.getResourceAsStream("/com/adiacent/menarini/relife/core/models/contactsPage.json");
        ctx.load().json(is, "/content/relife/corporate/en/about/contact.html");

        Resource c = spy(ctx.currentResource("/content/relife/corporate/en/about/contact.html"));
        ...
        params.put("resourcePath","/content/relife/corporate/en/about/contact/jcr:content/root/container/container/container");
        ...
        paths.add("/content/relife/corporate/en/about/contact.html/jcr:content/root/container/container/container");
        paths.add("/content/relife/corporate/en/about/contact.html/jcr:content/root/container/container/container/options");
        paths.add("/content/relife/corporate/en/about/contact.html/jcr:content/root/container/container/container/options/items/item0");
