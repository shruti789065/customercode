...
@SlingServletResourceTypes(
        ...
        selectors={FullSearchResultServlet.DEFAULT_SELECTOR})
@ServiceDescription("Relife - Search Result Servlet")

public class FullSearchResultServlet extends SlingSafeMethodsServlet {

    private final transient Logger logger = LoggerFactory.getLogger(this.getClass());
    public static final String DEFAULT_SELECTOR = "relifeSearchresult";
    ...
    protected JSONObject getResult(SlingHttpServletRequest request, ResourceResolver resourceResolver) throws RepositoryException, JSONException {
        ...
        if(request.getParameter("fulltext") != null){
            ...
            myXpathQuery.append(" AND (contains(p.*,'/settings/wcm/templates/page-content') ");
            myXpathQuery.append(" OR contains(p.*,'/settings/wcm/templates/country')) ");
