...
class LanguageNavigationModelTest {
    ...
    void setUp() {
        ...
        ctx.load().json(LanguageNavigationModelTest.class.getResourceAsStream("LanguageNavigationData.json"),"/content/experience-fragments/menarini-apac/en/site/header/master/jcr:content/root/section_navbar/wrapper/languagenavigation");
