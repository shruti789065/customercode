    ...
    function scrollToDeepLinkIdInCarousel() {
      if (containerUtils) {
        ...
        if (deepLinkItemIdx > -1) {
          ...
          if (
            deepLinkItem &&
            that._elements["item"][that._active].id !== deepLinkItem.id
          ) {
...
function toggleSmallScreenOnlyAttributeForAll() {
  ...
  window.addEventListener("load", function () {
    // Chiama la funzione toggleSmallScreenOnlyAttributeForAll al caricamento del documento
    toggleSmallScreenOnlyAttributeForAll();
  });

  // Aggiungi un listener per il ridimensionamento della finestra
  window.addEventListener("resize", function () {
    // Chiama la funzione toggleSmallScreenOnlyAttributeForAll al ridimensionamento della finestra
    toggleSmallScreenOnlyAttributeForAll();
  });
})();
